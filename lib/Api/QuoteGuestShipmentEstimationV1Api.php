...
class QuoteGuestShipmentEstimationV1Api
{
     ...
     * @return \MagentoApi\Model\QuoteDataShippingMethodInterface[]
     */
     ...
     * @throws \MagentoApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MagentoApi\Model\QuoteDataShippingMethodInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function quoteGuestShipmentEstimationV1EstimateByExtendedAddressPostWithHttpInfo($cart_id, $body = null)
    {
        $returnType = '\MagentoApi\Model\QuoteDataShippingMethodInterface[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MagentoApi\Model\QuoteDataShippingMethodInterface[]',
