...
class QuoteDataTotalsExtensionInterface implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['coupon_label'] = isset($data['coupon_label']) ? $data['coupon_label'] : null;
    }
    ...
    {
        return $this->container['coupon_label'];
    }

    /**
     * Sets coupon_label
     *
     * @param string $coupon_label coupon_label
     *
     * @return $this
     */
    public function setCouponLabel($coupon_label)
    {
        $this->container['coupon_label'] = $coupon_label;
